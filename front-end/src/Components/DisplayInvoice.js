...
const DisplayInvoice = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:8080/payments/payment/details/1')
  ...
  const handleDownloadPDF = () => {
   ...
   doc.addImage(imgData, 'PNG', 150, 10, 30, 30); // Adjust position and size as needed
    ...
    doc.setFontSize(12);
    doc.text('Invoice Details', 14, 10);
    doc.autoTable({
      startY: 70, // Adjust the vertical position as needed
      head: headers,
      body: data,
      theme: 'grid',
    ...
    <div className="container mt-4">
      <div className="row align-items-center">
        ...
        <div className="col-12 text-center">
          <h1 className="invoice_header">INVOICE DETAILS</h1>
        </div>
        </div>
